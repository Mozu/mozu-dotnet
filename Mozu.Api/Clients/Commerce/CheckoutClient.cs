...
;
		...
		/// <example>
		/// <code>
		///   var mozuClient=GetAvailableShipmentMethods( checkoutId);
		///   var checkoutGroupRatesClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<List<Mozu.Api.Contracts.CommerceRuntime.Checkouts.CheckoutGroupRates>> GetAvailableShipmentMethodsClient(string checkoutId)
		{
			var url = Mozu.Api.Urls.Commerce.CheckoutUrl.GetAvailableShipmentMethodsUrl(checkoutId);
			const string verb = "GET";
