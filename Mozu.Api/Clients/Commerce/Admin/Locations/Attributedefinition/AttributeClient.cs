...
/// -  â€” are custom attributes that enable you to uniquely describe an aspect of an order. Depending on the attribute definition, either you or a shopper can enter values for the order attribute. Refer to [Order Attributes](https://www.mozu.com/docs/guides/orders/order-attributes.htm) in the Guides section for more information.
	...
	public partial class AttributeClient 	{
		...
		{
			var url = Mozu.Api.Urls.Commerce.Admin.Locations.Attributedefinition.AttributeUrl.GetAttributesUrl(startIndex, pageSize, sortBy, filter, responseFields);
...
;
		...
		{
			var url = Mozu.Api.Urls.Commerce.Admin.Locations.Attributedefinition.AttributeUrl.GetAttributeVocabularyValuesUrl(attributeFQN);
			const string verb = "GET";
...
;
		...
		{
			var url = Mozu.Api.Urls.Commerce.Admin.Locations.Attributedefinition.AttributeUrl.GetAttributeUrl(attributeFQN, responseFields);
			const string verb = "GET";
...
;
		...
		{
			var url = Mozu.Api.Urls.Commerce.Admin.Locations.Attributedefinition.AttributeUrl.CreateAttributeUrl(responseFields);
		...
		{
			var url = Mozu.Api.Urls.Commerce.Admin.Locations.Attributedefinition.AttributeUrl.UpdateAttributeUrl(attributeFQN, responseFields);
