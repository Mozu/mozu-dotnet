...
;
		...
		/// <example>
		/// <code>
		///   var mozuClient=CancelItem( reason,  orderId,  orderItemId,  quantity,  updateMode,  version,  updateFulfillment,  sendEmail,  responseFields);
		///   var orderClient = mozuClient.WithBaseAddress(url).Execute().Result();
		/// </code>
		/// </example>
		public static MozuClient<Mozu.Api.Contracts.CommerceRuntime.Orders.Order> CancelItemClient(Mozu.Api.Contracts.CommerceRuntime.Orders.CanceledReason reason, string orderId, string orderItemId, int quantity, string updateMode =  null, string version =  null, bool? updateFulfillment =  null, bool? sendEmail =  null, string responseFields =  null)
		{
			var url = Mozu.Api.Urls.Commerce.Orders.OrderItemUrl.CancelItemUrl(orderId, orderItemId, quantity, updateMode, version, updateFulfillment, sendEmail, responseFields);
			const string verb = "PUT";
			var mozuClient = new MozuClient<Mozu.Api.Contracts.CommerceRuntime.Orders.Order>()
									.WithVerb(verb).WithResourceUrl(url)
