...
namespace Mozu.Api.Resources.Platform
{
	...
	public partial class UserDataResource  	{
		...
		/// <code>
		///   var userdata = new UserData();
		///   var stream = await userdata.CreateDBValueAsync( value,  dbEntryQuery);
		/// </code>
		/// </example>
		...
		/// <code>
		///   var userdata = new UserData();
		///   var stream = await userdata.UpdateDBValueAsync( value,  dbEntryQuery);
		/// </code>
		/// </example>
		...
		/// <code>
		///   var userdata = new UserData();
		///   var stream = await userdata.DeleteDBValueAsync( dbEntryQuery);
		/// </code>
		/// </example>
