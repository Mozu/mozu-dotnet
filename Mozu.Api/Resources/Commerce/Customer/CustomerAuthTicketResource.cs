...
namespace Mozu.Api.Resources.Commerce.Customer
{
	...
	public partial class CustomerAuthTicketResource  	{
		...
		/// </code>
		/// </example>
		public virtual async Task<Mozu.Api.Contracts.Customer.CustomerAuthTicket> CreateAnonymousShopperAuthTicketAsync(string responseFields =  null, CancellationToken ct = default(CancellationToken))
		{
		...
		/// </code>
		/// </example>
		public virtual async Task<Mozu.Api.Contracts.Customer.CustomerAuthTicket> CreateUserAuthTicketAsync(Mozu.Api.Contracts.Customer.CustomerUserAuthInfo userAuthInfo, string responseFields =  null, CancellationToken ct = default(CancellationToken))
		{
			MozuClient<Mozu.Api.Contracts.Customer.CustomerAuthTicket> response;
		...
		/// </code>
		/// </example>
		public virtual async Task<Mozu.Api.Contracts.Customer.CustomerAuthTicket> RefreshUserAuthTicketAsync(string refreshToken, string responseFields =  null, CancellationToken ct = default(CancellationToken))
		{
			MozuClient<Mozu.Api.Contracts.Customer.CustomerAuthTicket> response;
