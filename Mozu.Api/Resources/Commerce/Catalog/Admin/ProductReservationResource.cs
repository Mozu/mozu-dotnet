...
namespace Mozu.Api.Resources.Commerce.Catalog.Admin
{
	...
	public partial class ProductReservationResource  	{
		...
		/// <code>
		///   var productreservation = new ProductReservation();
		///   var stream = await productreservation.CommitReservationsAsync(_dataViewMode,  productReservations);
		/// </code>
		/// </example>
		public virtual async Task<System.IO.Stream> CommitReservationsAsync(List<Mozu.Api.Contracts.ProductAdmin.ProductReservation> productReservations, CancellationToken ct = default(CancellationToken))
		{
		...
		/// <code>
		///   var productreservation = new ProductReservation();
		///   var stream = await productreservation.DeleteProductReservationAsync(_dataViewMode,  productReservationId);
		/// </code>
		/// </example>
		public virtual async Task<System.IO.Stream> DeleteProductReservationAsync(int productReservationId, CancellationToken ct = default(CancellationToken))
		{
			MozuClient<System.IO.Stream> response;
