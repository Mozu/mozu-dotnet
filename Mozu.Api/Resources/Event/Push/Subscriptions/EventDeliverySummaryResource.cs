...
namespace Mozu.Api.Resources.Event.Push.Subscriptions
{
	...
	public partial class EventDeliverySummaryResource  	{
		...
		/// </code>
		/// </example>
		public virtual async Task<Mozu.Api.Contracts.Event.EventDeliverySummary> GetDeliveryAttemptSummaryAsync(string subscriptionId, int? id =  null, string responseFields =  null, CancellationToken ct = default(CancellationToken))
		{
