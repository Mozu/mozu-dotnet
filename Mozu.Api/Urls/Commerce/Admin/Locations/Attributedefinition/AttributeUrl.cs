...
namespace Mozu.Api.Urls.Commerce.Admin.Locations.Attributedefinition
{
	public partial class AttributeUrl 
	{
		...
		{
			var url = "/api/commerce/admin/locations/attributedefinition/attributes/?startIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&filter={filter}&responseFields={responseFields}";
		...
		{
			var url = "/api/commerce/admin/locations/attributedefinition/attributes/{attributeFQN}/VocabularyValues";
			var mozuUrl = new MozuUrl(url, MozuUrl.UrlLocation.TENANT_POD, false) ;
		...
		{
			var url = "/api/commerce/admin/locations/attributedefinition/attributes/{attributeFQN}?responseFields={responseFields}";
			var mozuUrl = new MozuUrl(url, MozuUrl.UrlLocation.TENANT_POD, false) ;
			mozuUrl.FormatUrl( "attributeFQN", attributeFQN);
			mozuUrl.FormatUrl( "responseFields", responseFields);
			return mozuUrl;
