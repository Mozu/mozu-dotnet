...
namespace Mozu.Api.Test.Factories.Commerce.Carts
{
	...
	public partial class ChangeMessageFactory : BaseDataFactory
	{
		...
		/// </example> 
		/// </summary>
		public static System.IO.Stream RemoveAllMessages(ServiceClientMessageHandler handler, 
		...
		/// </example> 
		/// </summary>
		public static System.IO.Stream RemoveMessage(ServiceClientMessageHandler handler, 
 		 string messageId, 
		 HttpStatusCode expectedCode = HttpStatusCode.OK, HttpStatusCode successCode = HttpStatusCode.OK)
		{
			SetSdKparameters();
